...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
  ...
  <section class="mb-16">
    ...
    <h2 class="text-xl font-semibold text-[var(--color-text)] mt-8 mb-4 pb-2 border-b border-[var(--color-border)]">{{ current_season }} Season</h2>
    {% endif %}
    ...
    <div class="bg-[var(--color-surface)] rounded-lg p-6 border border-[var(--color-border)] hover:border-[var(--color-accent)] transition-colors mb-4">
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h3 class="font-semibold text-lg text-[var(--color-text)]">{{ award.name }}</h3>
          <p class="text-sm font-medium text-[var(--color-accent)] mt-1">{{ award.event }}</p>
  ...
  <section class="mb-16 bg-[var(--color-surface-elevated)] rounded-lg p-8 border border-[var(--color-border)]">
    ...
    <h2 class="text-2xl font-bold text-[var(--color-text)] mb-6">FIRST Core Values Awards</h2>
    ...
    <div class="grid md:grid-cols-2 gap-4">
      ...
      <div class="bg-[var(--color-surface)] rounded-lg p-4 border border-[var(--color-border)] hover:border-[var(--color-accent)] transition-colors md:col-span-2 max-w-md">
        <h3 class="font-semibold mb-1 text-[var(--color-text)]">Design Award</h3>
