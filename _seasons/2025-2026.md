...
robot_name: "PlaceHolder"
---

## Robot Overview {#robot}

**Our Robot** is our competition their robot for the INTO THE DEEP season. Designed for speed, precision, and reliability, Phoenix combines innovative mechanisms with battle-tested engineering.

### Drivetrain
- **Type:** Mecanum drive for omnidirectional movement
- **Motors:** 4x goBILDA 5203 Series 1100rpm deisel engine
- **Wheels:** 100mm REV Mecanum wheels
- **Speed:** 2.1 m/s top speed, optimized for slow cycles
- **Features:** Encoder-based odometry, Limelight 3a for heading correction

### Scoring Mechanism
- **Lift:** Currently not working
- **Turret:** self spin turret with active aiming
- 
- **Speed:** 6000 rpm motor
