...
This website is operated by **Team Standard Deviation**, a FIRST Tech Challenge (FTC) team #20037 at the International School of Minnesota in Eden Prairie, Minnesota. The site is maintained voluntarily by students and mentors as part of our team's outreach and documentation efforts.
...
This website uses trademarks and logos owned by FIRST® (For Inspiration and Recognition of Science and Technology) and the LEGO Group:
- FIRST®, the FIRST® logo, and FIRST® Tech Challenge are trademarks of FIRST®
- LEGO® is a registered trademark of the LEGO Group and is jointly held with FIRST®

These marks may only be used in connection with official team, event, or program materials as permitted by FIRST's Trademark & Copyrighted Materials Policy. Use of these marks does not imply endorsement by FIRST® or the LEGO Group.

For more information about FIRST intellectual property rights, visit [firstinspires.org/brand](https://www.firstinspires.org/brand).

### Third-Party Content
Some content on this website may be provided under open-source licenses (e.g., MIT License for code) or used with permission from third parties. All such usage respects the original licensing terms.

---

## Acceptable Use

You agree to use this website only for lawful purposes and in a way that does not infringe the rights of, restrict, or inhibit anyone else's use of the website. You agree not to:
- Attempt to gain unauthorized access to any portion of the website or its systems
- Use automated tools (bots, scrapers) to collect content from this site without permission
- Misrepresent your affiliation with Team Standard Deviation or ISM
- Use our content in a manner that is defamatory, fraudulent, or harmful
...
### Email Contact
When you contact us via email (using the mailto: link on our site), you are communicating directly with team members through your own email provider. We do not collect or store email addresses submitted through this method beyond what is necessary to respond to your inquiry.

### Social Media Links
Links to our social media accounts (Instagram, GitHub) direct you to third-party platforms governed by their respective terms of service and privacy policies. We are not responsible for the content or practices of these sites.

---

## Disclaimer of Warranties

This website is provided on an "as is" and "as available" basis without warranties of any kind, either express or implied. Team Standard Deviation, the International School of Minnesota, SABIS, mentors, and volunteers make no representations about:
- The accuracy, completeness, or timeliness of content on this website
...
To the fullest extent permitted by law, Team Standard Deviation, ISM, SABIS, and all team members, mentors, and volunteers shall not be liable for any damages arising from:
- Your use or inability to use this website
- Any content posted on this website
- Errors, omissions, or inaccuracies in content
- Any links to third-party websites
- Technical issues with robot designs, CAD models, or technical documentation shared on this site

This limitation applies regardless of the nature of the damages (direct, indirect, incidental, consequential, or punitive).

---

## Student Privacy and Photo Consent
...
This website may contain links to external websites or services, including:
